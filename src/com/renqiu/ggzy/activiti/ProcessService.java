...
public class ProcessService {
	...
	public void backProcess(String taskId, String activityId,
		...
		for (Task task : taskList) {
			commitProcess(task.getId(), task.getProcessInstanceId(), variables,
					activityId, "[退回]" + StringUtils.defaultString(message, ""));
		}
	}
	...
	public void callBackProcess(String taskId, String activityId, String message)
		...
		List<Task> taskList = findTaskListByKey(
				...
				findTaskById(taskId).getTaskDefinitionKey());
		for (Task task : taskList) {
			commitProcess(task.getId(), task.getProcessInstanceId(), null,
					activityId, message);
		}
	}
	 ...
	 * @throws Exception
	 */
	private void commitProcess( String taskId, String processInstanceId,
			Map<String, Object> variables, String activityId,
		...
		if (StringUtils.isEmpty(activityId)) {
			...
			turnTransition(taskId, processInstanceId, activityId, variables,
					commentMessage);
		}
	}
	...
	public void endProcess(String taskId) throws Exception {
		...
		commitProcess(taskId, task.getProcessInstanceId(), null,
				endActivity.getId(), "[中止流程]");
	}
	 ...
	 * @throws Exception
	 */
	private void turnTransition(String taskId, String processInstanceId,
