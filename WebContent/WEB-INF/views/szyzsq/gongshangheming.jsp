...
<body>
	...
	<form:form id="inputForm" action="${ctx}/szyzsq/completeTask" method="post" class="form-horizontal">
		<fieldset>
			...
			<td>&nbsp;</td> 
				<td>
					<input type="radio" name="input" value="0" checked onclick="javascript:$('#reasonDiv').hide();">同意受理&nbsp;
					<input type="radio" name="input" value="1" onclick="javascript:$('#reasonDiv').show();">拒绝受理 
				</td>
			</tr>
			...
			<tr>
			 ...
			 <td colspan="2">
			 	<div>
			 	<fieldset> <legend><small>审批历史</small></legend>
			 		<div>
			 			<table>
			 			<thead>
			 				<tr>
